...
internal sealed class CompanyDbContext : DbContext, IUnitOfWorkCompany
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CashRegister>().Property(p => p.CurrencyType)
            .HasConversion(x => x.Value, value => CurrencyTypeEnum.FromValue(value));
        ...
        modelBuilder.Entity<Customer>().Property(p => p.Type)
            .HasConversion(x => x.Value, val => CustomerTypeEnum.FromValue(val));
        ...
        modelBuilder.Entity<CustomerDetail>().Property(p => p.Type)
            .HasConversion(x => x.Value, val => CustomerDetailTypeEnum.FromValue(val));
